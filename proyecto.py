...
while True:
    ...
    if opcion == 1:
        ...
        print("Función de ordenamiento por nota aún no implementada.")
    elif opcion == 9:
        print("Función de ordenamiento por nombre aún no implementada.")
    elif opcion == 10:
        print("Función de búsqueda binaria aún no implementada.")
    elif opcion == 11:
        print("Simulación de cola de revisión aún no implementada.")
    elif opcion == 12:
        mostrarhistorial(historialgeneral)
    elif opcion == 13:
        print(f"Gracias por usar el sistema, {nom_pers}. ¡Hasta pronto!")
        break
    else:
